...
public class ManufacturerPersistenceTests {
	...
	public void testDistinct() throws Exception {
		Manufacturer mans = manufacturerJpaRepository.findDistinctManufacturerByNameLike("Fender Musical Instruments Corporation");
		assertEquals("Fender Musical Instruments Corporation", mans.getName());
	}
